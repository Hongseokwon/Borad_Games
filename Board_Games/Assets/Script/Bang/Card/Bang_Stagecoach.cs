...
public class Bang_Stagecoach : Bang_Card
{
    ...
    {
        My_Type = Bang_Game_Manager.BANG_CARD.STAGECOACH;
    ...
    public override void Card_Use(int Player_Num, int Target_Num = 0)
    {
        ...
        Bang_Message_Manager.Instance.Create_Message(Bang_Game_Manager.Instance.Player_List[Player_Num].GetComponent<Bang_Player>().name + "이(가) 역마차 카드를 사용하였습니다.", 1);
