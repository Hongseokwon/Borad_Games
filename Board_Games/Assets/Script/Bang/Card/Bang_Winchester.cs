...
public class Bang_Winchester : Bang_Card_Weapon
{
    ...
    {
        My_Type = Bang_Game_Manager.BANG_CARD.WINSCHESTER;
        ...
        Front_Sprite = Bang_Image_Manager.Instance.Get_Card_Sprite(Bang_Game_Manager.BANG_CARD.WINSCHESTER);

        Weapon_type = WEAPON_TYPE.WEAPON_WINCHESTER;
    ...
    public override void Card_Use(int Player_Num, int Target_Num = -1)
    {
        ...
        Bang_Message_Manager.Instance.Create_Message(Str_Player + "이(가) 윈체스터 카드를 사용합니다.", 1);
