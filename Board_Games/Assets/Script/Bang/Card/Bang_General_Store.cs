...
public class Bang_General_Store : Bang_Card
{
    ...
    {
        My_Type = Bang_Game_Manager.BANG_CARD.GENERAL_STORE;
        ...
        Front_Sprite = Bang_Image_Manager.Instance.Get_Card_Sprite(Bang_Game_Manager.BANG_CARD.GENERAL_STORE);
    }
    ...
    public override void Card_Use(int Player_Num, int Target_Num = 0)
    {
        ...
        Bang_Message_Manager.Instance.Create_Message(Str_Player + "이(가) 잡화점 카드를 사용합니다.", 1);

        Bang_Game_Manager.Instance.General_Store_Open(Player_Num);
    }
