...
public class Bang_Remington : Bang_Card_Weapon
{
    ...
    {
        My_Type = Bang_Game_Manager.BANG_CARD.REMINGTON;
        ...
        Front_Sprite = Bang_Image_Manager.Instance.Get_Card_Sprite(Bang_Game_Manager.BANG_CARD.REMINGTON);

        Weapon_type = WEAPON_TYPE.WEAPON_REMINGTON;
    ...
    public override void Card_Use(int Player_Num, int Target_Num = -1)
    {
        ...
        Bang_Message_Manager.Instance.Create_Message(Str_Player + "이(가) 레밍턴 카드를 사용합니다.", 1);
