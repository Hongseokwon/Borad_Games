...
public class Bang_Indians : Bang_Card
{
    ...
    {
        My_Type = Bang_Game_Manager.BANG_CARD.INDIANS;
        ...
        Front_Sprite = Bang_Image_Manager.Instance.Get_Card_Sprite(Bang_Game_Manager.BANG_CARD.INDIANS);
    }
    ...
    public override void Card_Use(int Player_Num, int Target_Num = 0)
    {
        ...
        Bang_Message_Manager.Instance.Create_Message(Str_Player + "이(가) 인디언 카드를 사용합니다.", 1);

        Bang_Game_Manager.Instance.Indian_Use(Player_Num);
    }
